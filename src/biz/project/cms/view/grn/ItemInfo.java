 ...
 * @author Amila(Polta)
 */
public class ItemInfo extends javax.swing.JDialog {
     ...
     */
    public ItemInfo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ItemInfo(java.awt.Frame parent, boolean modal, ArrayList<Object> list) {
        super(parent, modal);
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/image/Home/Logo Company.png")).getImage());
        this.list = list;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ItemInfo dialog = new ItemInfo(new javax.swing.JFrame(), true);
    ...
    private void next() {
        ...
        if (addW == 0) {
            AddWarenty itemInfo = new AddWarenty(null, true, list);
