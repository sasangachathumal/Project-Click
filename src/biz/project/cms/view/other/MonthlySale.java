 ...
 * @author Vihanga
 */
public class MonthlySale extends javax.swing.JDialog {

    /**
     * Creates new form MonthlySale
     */
    public MonthlySale(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            if (validateDay()) {
                ...
                try {
                    ...
                    JasperReport compileReport = JasperCompileManager.compileReport(getClass()
                            .getResourceAsStream("/reports/monthsale.jrxml"));
  ...
  Validation.textYear(txtYr);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlySale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MonthlySale dialog = new MonthlySale(new javax.swing.JFrame(), true);
