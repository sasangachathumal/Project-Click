...
import biz.project.cms.controller.CalcTotController;
 ...
 * @author Vihanga
 */
public class TotalSale extends javax.swing.JDialog {

    /**
     * Creates new form TotalSale
     */
    public TotalSale(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        setTitle("Total Day Sale");//
    ...
    private boolean validateDay() {
        ...
        return Integer.parseInt(dateFormat.format(date1)) >= Integer.parseInt(dateFormat.format(date));
    }
    ...
    private void initComponents() {
        ...
        pic = new org.jdesktop.swingx.JXDatePicker();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (validateDay()) {
            ...
            dispose();
            try {
                double d1 = CalcTotController.getTotalSales(getDate());
                double d2 = CalcTotController.getTotalServices(getDate());
                int i1 = CalcTotController.getTotalSaleCount(getDate());
                int i2 = CalcTotController.getTotalServiceCount(getDate());
                double total = d1 + d2;
                int totali = i2 + i1;
                JasperReport compileReport = JasperCompileManager.compileReport(getClass()
                        .getResourceAsStream("/reports/totaldaysale.jrxml"));
                map.put("SALE", d1);
                map.put("TOTAL", total);
                map.put("SERVICE", d2);
                map.put("SALEC", i1);
                map.put("TOTALC", totali);
                map.put("SERVICEC", i2);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TotalSale dialog = new TotalSale(new javax.swing.JFrame(), true);
    ...
    private org.jdesktop.swingx.JXDatePicker pic;
